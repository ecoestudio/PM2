...
IF NOT EXIST .git (
  ...
  PortableGit\bin\git.exe remote add origin https://github.com/ecoestudio/playone_monitor2.git
  PortableGit\bin\git.exe remote update
  PortableGit\bin\git.exe checkout master
)
PortableGit\bin\git.exe reset --hard HEAD
PortableGit\bin\git.exe pull https://github.com/ecoestudio/playone_monitor2.git --force
